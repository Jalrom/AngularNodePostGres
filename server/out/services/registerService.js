...
let RegisterService = class RegisterService {
    createUser(player) {
        return __awaiter(this, void 0, void 0, function* () {
            const username = yield this.userRepository.findByUsername(player.username);
            const email = yield this.userRepository.findByEmail(player.email);
            ...
            return yield this.userRepository.create(player);
        });
    }
};
__decorate([
...
], RegisterService.prototype, "userRepository", void 0);
